...
namespace SafariGo.DataAccess.Migrations
{
    ...
    [Migration("20230517124042_AddMapToCategoryItem")]
    partial class AddMapToCategoryItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SafariGo.Core.Models.Like", b =>
                {
            ...
            modelBuilder.Entity("SafariGo.Core.Models.Like", b =>
                {
                    b.HasOne("SafariGo.Core.Models.Post", null)
                        .WithMany("Likes")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
